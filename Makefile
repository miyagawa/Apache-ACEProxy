# This Makefile is for the Apache::ACEProxy extension to perl.
#
...
#	NAME => q[Apache::ACEProxy]
#	PREREQ_PM => { Convert::RACE=>q[0.06], URI=>q[1.15], Unicode::String=>q[2.06], mod_perl=>q[1.21], LWP::UserAgent=>q[1.8] }
#	VERSION_FROM => q[lib/Apache/ACEProxy.pm]
...
DISTNAME = Apache-ACEProxy
NAME_SYM = Apache_ACEProxy
VERSION = 0.01
VERSION_SYM = 0_01
XS_VERSION = 0.01
INST_BIN = blib/bin
...
FULLEXT = Apache/ACEProxy
BASEEXT = ACEProxy
PARENT_NAME = Apache
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Apache/ACEProxy.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
H_FILES = 
MAN1PODS = 
MAN3PODS = lib/Apache/ACEProxy.pm \
	lib/Apache/ACEProxy/RACE.pm
...
TO_INST_PM = lib/Apache/ACEProxy.pm \
	lib/Apache/ACEProxy/RACE.pm

PM_TO_BLIB = lib/Apache/ACEProxy.pm \
	$(INST_LIB)/Apache/ACEProxy.pm \
	lib/Apache/ACEProxy/RACE.pm \
	$(INST_LIB)/Apache/ACEProxy/RACE.pm
...
manifypods : pure_all lib/Apache/ACEProxy.pm \
	lib/Apache/ACEProxy/RACE.pm
	@$(POD2MAN) \
	lib/Apache/ACEProxy.pm \
	$(INST_MAN3DIR)/Apache::ACEProxy.$(MAN3EXT) \
	lib/Apache/ACEProxy/RACE.pm \
	$(INST_MAN3DIR)/Apache::ACEProxy::RACE.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -f $(INST_LIB)/Apache/ACEProxy.pm $(INST_LIB)/Apache/ACEProxy/RACE.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Apache-ACEProxy\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>Apache-ACEProxy</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"Convert-RACE\" VERSION=\"0,06,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"LWP-UserAgent\" VERSION=\"1,8,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"URI\" VERSION=\"1,15,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"Unicode-String\" VERSION=\"2,06,0,0\" />\n}. qq{\t\t<DEPENDENCY NAME=\"mod_perl\" VERSION=\"1,21,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-freebsd\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Apache-ACEProxy.ppd
